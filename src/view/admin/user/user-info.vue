  ...
  <div class="container">
    ...
    >
      <el-form-item label="用户名" prop="username">
        <el-input v-model="form.username" :disabled="isEdited" clearable size="medium"></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="pageType === 'add'" label="确认密码" label-position="top" prop="confirm_password">
      ...
      <el-form-item v-show="submit" class="submit">
        <el-button :loading="loading" type="primary" @click="submitForm('form')">保 存</el-button>
