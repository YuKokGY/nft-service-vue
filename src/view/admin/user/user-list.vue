<template>
  <div class="container">
    <div class="header">
      ...
      <!-- 分组选择下拉框 -->
      <el-select v-model="group_id" clearable filterable placeholder="请选择分组" size="medium" @change="handleChange">
    ...
    <!-- 弹窗 -->
    <el-dialog :append-to-body="true" :before-close="handleClose" :visible.sync="dialogFormVisible" title="用户信息">
