<template>
  <div style="height:100%;">
    <el-container>
      <el-aside :style="asideStyle" :width="sideBarWidth" class="aside">
        <side-bar :is-phone="isPhone" :isCollapse="isCollapse"></side-bar>
      </el-aside>
      <el-container>
        <el-header class="header">
          <div class="left">
            <div ref="operate" class="operate">
              <i :class="{ rotate: foldState }" class="iconfont icon-fold" @click="changeSlidebarState"/>
              <nav-bar></nav-bar>
            </div>
        ...
        <back-top :bottom="50" :fontSize="34" :right="50"></back-top>
      </el-container>
      <div :class="{ show: isPhone && isCollapse }" class="sidenav-mask" @click="changeSlidebarState"></div>
    </el-container>
  </div>
</template>

<script>
import {AppMain, BackTop, MenuTab, NavBar, ReuseTab, SideBar} from '@/component/layout'
