        ...
        <div class="container">
            <div class="header">
                <div class="title">
                    ...
                    <el-select
                        v-model="modelDO.is_used"
                        class="select"
                        clearable
                        placeholder="状态"
                        size="medium"
                        @change="changeSelect"
                        @clear="modelDO.is_used = null"
                    >
                        <el-option
            ...
            >
                ...
                <el-table-column :width="200" label="卡号" prop="code"></el-table-column>
                <el-table-column :width="100" label="状态">
                    <template slot-scope="scope">
                        <el-tag :type="scope.row.is_used === 0 ? 'success' : 'danger'" effect="dark">
                            {{ scope.row.is_used === 0 ? '未使用' : '已使用' }}
                        </el-tag>
                    </template>
                </el-table-column>
...
export default {
    ...
    data() {
        return {
            ...
            showEdit: false,
            operate: [],
            status: [{ label: '已使用', value: 1 }, { label: '未使用', value: 0 }],
            date: [],
            modelDO: {},
        }
    },
    ...
    methods: {
        ...
        async getList(val) {
            ...
            try {
                this.loading = true
                const res = await baseModel.postList('/cms/convertCode/getAll', val, {
