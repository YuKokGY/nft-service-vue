  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      <el-card class="box-card" style="margin-bottom:50px;padding-bottom:20px;">
        ...
        <div class="block-box">
          <i v-if="!list.length" class="iconfont icon-jia plus" @click="addContent"></i>
          <el-row v-for="(item, index) in list" :key="index" class="input-row">
            <el-input v-model="item.text" class="input-detail" placeholder="请输入内容" size="medium"></el-input>
            <div class="function">
              <i class="iconfont icon-jian1 minus" @click="removeContent(index)"></i>
              <i v-if="index === list.length - 1" class="iconfont icon-jia plus" @click="addContent"></i>
            </div>
          </el-row>
        </div>
        <el-collapse>
