    ...
    <div class="lin-wrap-ui">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <template>
              <el-alert effect="dark" title="成功提示的文案" type="success"></el-alert>
              <el-alert effect="dark" title="消息提示的文案" type="info"></el-alert>
              <el-alert effect="dark" title="警告提示的文案" type="warning"></el-alert>
              <el-alert effect="dark" title="错误提示的文案" type="error"></el-alert>
            </template>
          </div>
        </el-row>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <template>
              <el-alert :closable="false" title="不可关闭的 alert" type="success"></el-alert>
              <el-alert close-text="知道了" title="自定义 close-text" type="info"></el-alert>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <template>
              <el-alert show-icon title="成功提示的文案" type="success"></el-alert>
              <el-alert show-icon title="消息提示的文案" type="info"></el-alert>
              <el-alert show-icon title="警告提示的文案" type="warning"></el-alert>
              <el-alert show-icon title="错误提示的文案" type="error"></el-alert>
            </template>
          </div>
        </el-row>
        <el-collapse>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <template>
              <el-alert center show-icon title="成功提示的文案" type="success"></el-alert>
              <el-alert center show-icon title="消息提示的文案" type="info"></el-alert>
              <el-alert center show-icon title="警告提示的文案" type="warning"></el-alert>
              <el-alert center show-icon title="错误提示的文案" type="error"></el-alert>
            </template>
          </div>
        </el-row>
        <el-collapse>
