        ...
        <el-row>
          <template>
            <div class="block">
              ...
              <el-date-picker v-model="value1" placeholder="选择日期时间" type="datetime"></el-date-picker>
            </div>
            <div class="block">
            ...
            <div class="block">
              ...
              <el-date-picker v-model="value3" default-time="12:00:00" placeholder="选择日期时间" type="datetime">
              </el-date-picker>
            </div>
          </template>
        </el-row>
