  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value2" placeholder="请选择" size="medium">
            <el-option
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value3" clearable placeholder="请选择" size="medium">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value4" multiple placeholder="请选择" size="medium">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value8" allow-create default-first-option filterable multiple placeholder="请选择标签">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-row>
        <el-collapse>
