  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col :span="12">
            <el-input v-model="input1" placeholder="请输入内容" size="medium"></el-input>
          </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col :span="12">
            <el-input disabled placeholder="禁止输入" size="medium"></el-input>
          </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col :span="12">
            <el-input v-model="input2" placeholder="请输入内容" size="medium" suffix-icon="el-icon-edit"></el-input>
          </el-col>
        </el-row>
        <el-row style="margin-top:20px">
          <el-col :span="12">
            <el-input v-model="input3" placeholder="请输入内容" prefix-icon="el-icon-search" size="medium"></el-input>
          </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col>
            <el-col :span="12">
              <el-input v-model="input" class="input-with-select" placeholder="请输入内容" size="medium">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-input v-model="input6" placeholder="请输入内容" suffix-icon="el-icon-date"></el-input>
          </el-col>
          <el-col :span="6">
            <el-input v-model="input7" placeholder="请输入内容" size="medium" suffix-icon="el-icon-date"></el-input>
          </el-col>
          <el-col :span="6">
            <el-input v-model="input8" placeholder="请输入内容" size="small" suffix-icon="el-icon-date"></el-input>
          </el-col>
          <el-col :span="6">
            <el-input v-model="input9" placeholder="请输入内容" size="mini" suffix-icon="el-icon-date"></el-input>
          </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
