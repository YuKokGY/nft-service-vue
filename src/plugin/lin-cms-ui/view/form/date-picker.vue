          ...
          <div>
            <div class="container">
              ...
              <div class="block">
                ...
                <el-date-picker v-model="value4" placeholder="选择月" type="month"></el-date-picker>
              </div>
            </div>
            <div class="container">
              <div class="block">
                <span class="demonstration">年</span>
                <el-date-picker v-model="value5" placeholder="选择年" type="year"></el-date-picker>
              </div>
              <div class="block">
                <span class="demonstration">多个日期</span>
                <el-date-picker v-model="value6" placeholder="选择一个或多个日期" type="dates"></el-date-picker>
              </div>
            </div>
          </div>
        </el-row>
