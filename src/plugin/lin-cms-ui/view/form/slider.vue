    ...
    <div class="lin-wrap-ui">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block">
              <el-slider v-model="value9" :max="10" range show-stops></el-slider>
            </div>
          </template>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block">
              <el-slider v-model="value10" height="200px" vertical></el-slider>
            </div>
          </template>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block">
              <el-slider v-model="value11" :marks="marks" range></el-slider>
            </div>
          </template>
        </el-row>
        <el-collapse>
