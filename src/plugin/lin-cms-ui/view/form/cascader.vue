  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
        ...
        <el-row>
          <el-col>
            ...
            <div class="block">
              ...
              <el-cascader v-model="selectedOptions2" :options="options" expand-trigger="hover" @change="handleChange">
              </el-cascader>
            </div>
          </el-col>
        </el-row>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <el-cascader v-model="selectedOptions3" :options="options1"></el-cascader>
          </div>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            ...
            <el-cascader :options="options2" :props="props" @active-item-change="handleItemChange"></el-cascader>
          </div>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div class="block">
            ...
            <el-cascader :options="options" filterable placeholder="试试搜索：指南"></el-cascader>
          </div>
          <div class="block">
            <span class="demonstration">可选择任意一级菜单的选项</span>
            <el-cascader :options="options" change-on-select filterable placeholder="试试搜索：指南"></el-cascader>
          </div>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
