            ...
            <el-row class="block-col-2">
              <el-col :span="12">
                ...
                <el-dropdown @command="handleCommand">
                  <span class="el-dropdown-link"> 下拉菜单<i class="el-icon-arrow-down el-icon--right"></i> </span>
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="黄金糕" icon="el-icon-plus">黄金糕</el-dropdown-item>
                    <el-dropdown-item command="狮子头" icon="el-icon-circle-plus">狮子头</el-dropdown-item>
                    <el-dropdown-item command="螺蛳粉" icon="el-icon-circle-plus-outline">螺蛳粉</el-dropdown-item>
                    <el-dropdown-item command="双皮奶" icon="el-icon-check">双皮奶</el-dropdown-item>
                    <el-dropdown-item command="蚵仔煎" icon="el-icon-circle-check-outline">蚵仔煎</el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </el-col>
              <el-col :span="12">
