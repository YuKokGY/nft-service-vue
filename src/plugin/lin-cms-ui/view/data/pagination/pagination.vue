  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
        ...
        <el-row>
          <div>
            <div class="block">
              ...
              <el-pagination :total="50" layout="prev, pager, next"></el-pagination>
            </div>
            <div :style="{ marginTop: 30 + 'px' }" class="block">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <el-pagination :page-size="20" :pager-count="11" :total="1000" layout="prev, pager, next"></el-pagination>
        </el-row>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <el-pagination :total="50" layout="prev, pager, next" small></el-pagination>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
