  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <el-tag v-for="tag in tags" :key="tag.name" :type="tag.type" closable @close="handleCloseTag(tag)">
              {{ tag.name }}
            </el-tag>
          </div>
        </el-row>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            ...
            <el-tag closable size="medium">中等标签</el-tag>
            <el-tag closable size="small">小型标签</el-tag>
            <el-tag closable size="mini">超小标签</el-tag>
          </div>
        </el-row>
        <el-collapse>
          <el-collapse-item name="2" title="查看代码">
