<template>
  <el-dropdown :hide-on-click="hideOnClick" :placement="placement" :trigger="trigger">
    <div class="notify">
      <el-badge :hidden="hidden" :is-dot="isDot" :max="max" :value="value" class="item">
        <i :class="icon"></i>
      </el-badge>
    </div>
    <el-dropdown-menu slot="dropdown">
      ...
      <div :style="{ 'min-height': height + 'px', 'max-height': height + 'px' }" class="content">
        <div
        ...
        >
          <div class="css-sumlaa">
            <svg fill="currentColor" height="120" viewBox="0 0 150 120" width="150">
