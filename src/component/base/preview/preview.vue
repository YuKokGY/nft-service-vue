<template>
  <div v-if="data.length">
    <div ref="myGallery" :data-pswp-uid="radom" class="my-gallery">
      <div v-if="slides.length">
        <div v-for="(l, index) in slides" :key="radom + '_' + index"><img :src="l" alt="" preview/></div>
      </div>
    </div>
    <div ref="pswpWrap" aria-hidden="true" class="pswp" role="dialog" tabindex="-1">
